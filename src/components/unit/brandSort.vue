<template>
  <div>
    ...
    <el-cascader :options="options" v-model="selectedOptions" size="small" ref="cascaderAddr" filterable
      @change="handleChange" change-on-select placeholder="请选择上级分类" />
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      handleChange(e) {
        ...
        // var   thsAreaCode = this.$refs['cascaderAddr'].getCheckedNodes()[0].label    // 获取label值
