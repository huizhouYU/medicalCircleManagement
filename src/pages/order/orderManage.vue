          ...
          <template v-for="(item,index) in currentPageData">
            ...
            <tr class="order-detail">
              ...
              <td style="width: 12%;">{{item.orderPrice}}
                <div>(免运费)</div>
                <template v-if="item.OrderStatus==1 || item.OrderStatus==2">
                  <div class="orderState-detail" @click="openPirceDialog(item.number)">修改价格</div>
                </template>
              </td>
              <td style="width: 15%;">
                <template v-if="item.OrderStatus==1">
                  <!-- <div class="orderState-detail info-span-interval">审核</div> -->
                  ...
                  <!-- <div class="orderState-detail info-span-interval">取消订单</div> -->
                </template>
                ...
                <template v-else-if="item.OrderStatus==3">
                  ...
                  <!-- <div class="orderState-detail info-span-interval">发货</div> -->
                </template>
                <template v-else>
                  <el-button type="info" size="mini" plain disabled>无</el-button>
                  <!-- <div class="orderState-other">无</div> -->
                </template>
              </td>
            </tr>
          </template>
